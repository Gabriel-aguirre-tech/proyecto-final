...
clima.addEventListener('click', ()=>{
    const url = `https://api.openweathermap.org/data/2.5/weather?q=buenos%20aires&appid=${"0ca063b746578ffb14d9f9455bdb165a"}&lang=es`
    fetch(url) 
    .then((res) =>{
        return res.json();
    })
    ...
    let tem = respuesta.weather[0].description;
